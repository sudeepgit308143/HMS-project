...
<body>
	<section class="container"> <form:form method="post"
		action="${pageContext.request.contextPath}/admin/doctorMgmt/updateDoctor" modelAttribute="doctBean"
		class="form-horizontal">
		<fieldset>
			<legend>Edit Doctor</legend>
			<div class="form-group">
				<label class="control-label col-lg-2 col-lg-2" for="name">Doctor
					id</label>
				<div class="col-lg-10">
					<form:input id="Doctor id" path="id" type="text"
			...
			<div class="form-group">
				<label class="control-label col-lg-2 col-lg-2" for="manufacturer">Role</label>
				<div class="col-lg-10">
